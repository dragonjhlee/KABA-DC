...
//------------------------
        case 110:
            ...
            break ;
        case 111:
            $out = __('Example: <strong>All</strong>', 'staff-list');
            break ;
        case 112:
            $out = __('Category Page URL', 'staff-list');
            break ;
        case 113:
            $out = __('AZ Menu', 'staff-list');
            break ;
        case 114:
            $out = __('Add categoty slugs. Category names will show up as item names.', 'staff-list');
            break ;
        case 115:
...
//--------------------------------
        ...
        case 188:
            ...
            break;
        case 189:
            $out = __('Sort Text (manual entry)', 'staff-list');
            break;
//--------------------------------
        case 190:
            $out = __('Sort Text (copy from Single Line Text)', 'staff-list');
            break;
        case 191:
            $out = __('Sort Text (copy from Multipart Field)', 'staff-list');
            break;
        case 192:
            $out = __('Isotope', 'staff-list');
            break;
        case 193:
...
//--------------------------------
        ...
        case 203:
            ...
            break;
        case 204:
            $out = __('All Templates', 'staff-list');
            break;
        case 205:
...
//--------------------------------
        ...
        case 241:
            ...
            break;
        case 242:
             $out = __('How to publish staff page (Staff List).', 'staff-list');
            break;
        case 243:
...
//--------------------------------
        ...
        case 273:
            ...
            break;
        case 274:
            $out = __('Static Label + Drop-Down List', 'staff-list');
            break;
        case 275:
            $out = __('Static Label', 'staff-list');
            break;
        case 276:
            $out = __('Category Menu', 'staff-list');
            break;
        case 277:
...
//--------------------------------
        ...
        case 292:
            ...
            break;
        case 293:
            $out = __('Displayed next to the data field.', 'staff-list');
            break;
        case 294:
...
//--------------------------------
        ...
        case 325:
            ...
            break;
        case 326:
            $out = __('How to publish a Single Page.', 'staff-list');
            break;
        case 327:
...
//--------------------------------
        ...
        case 332:
            ...
            break;
        case 333:
            $out = __('This option has been deprecated. It’s kept for backward compatibility but may be removed in a future version.', 'staff-list');
            break;
        case 334:
            $out = __('Please use <strong>menu shortcode parameter</strong> instead.', 'staff-list');
            break;
        case 335:
            $out = __('', 'staff-list');
            break;
