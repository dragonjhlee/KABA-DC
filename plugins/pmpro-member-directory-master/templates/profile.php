...

{
	...
	<form style="margin-right:15%;" action="<?php echo $directory_url; ?>" method="post" role="search" class="pmpro_member_directory_search search-form">
	...
	<?php
...

		{
			...
			<div style="margin-left:15%;"id="pmpro_member_profile-<?php echo $pu->ID; ?>" class="pmpro_member_profile">
