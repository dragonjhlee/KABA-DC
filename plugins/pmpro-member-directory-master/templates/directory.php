...

	{
		...
		<div class="pmpro_member_directory" style="width:auto">
...

			{
				...
				<div class="tab">
					<button class="tablinks" onclick="openTab(event, 'Attorneys')" id="defaultTab" style="color:white; font-weight: 700;">Attorneys</button>
					<button class="tablinks" onclick="openTab(event, 'Law Students')" style="color:white; font-weight: 700;">Law Students</button>
				</div>
