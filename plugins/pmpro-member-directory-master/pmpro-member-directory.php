			...
			<tr class="user-hide-directory-wrap">
				...
				<td>
					<label for="hide_directory">
						<input name="hide_directory" type="checkbox" id="hide_directory" <?php checked( get_user_meta($user->ID, 'pmpromd_hide_directory', true), 1 ); ?> value="1"><?php printf(__('Display in Public %s','pmpromd'), get_the_title($pmpro_pages['directory']) ); ?>
					</label>
				</td>
			</tr>
		</tbody>
