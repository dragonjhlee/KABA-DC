   ...
   <div class="container <?php echo ( !empty($themetek_page_layout) ? 'fullwidth' : '' );?>">
     <div class="row single-page-content">
			 ...
			 ?>
				 ...
				 <div id="primary" class="content-area" style="margin-left: 15%;width: 75%;">
					 ...
					 <form action="" method="post" enctype="multipart/form-data">
						 ...
						 jQuery(document).ready(function () {
							 ...
							 function addBarAdmission(){
								 ...
								 + "<td style='float: left; margin-right: 5%; margin-left: 2%;' class='name_Table'><input type='text' name='ba_area[]' class='kaba_txtBox' placeholder='Jurisdiction/State' /></td>"
								 + "<td style='float: left;' class='name_Table'><input type='text' name='ba_date[]' class='kaba_txtBox' placeholder='YYYY' /></td>"
								 + "<td class='name_Table' style='float: left; margin-top: 2%;'><span class='btnDelete' style='font-size: 25px; cursor: pointer;' onclick='deleteBarAdmission()'>x</span></td>"
								 + "</tr>";
							 ...
							 function addLanguage(){
								 var fields = "<tr class='name_Table'>"
								 + "<td style='float: left; margin-top: 6%;' class='name_Table'><input type='text' name='lang_name[]' class='kaba_txtBox' placeholder='Other Language' /></td>"
								 + "<td class='name_Table'>"
								 + "<select name='lang_level[]' class='kaba_select'>"
							 ...
							 function addLawSchool(){
								 ...
								 +				'<input type="text" name="more_school_other[]" size="20" class="kaba_txtBox" style="margin-top: 3%;">'
								 +			'</td>'
								 +		"</tr>"
					 ...
					 <table class="name_Table" id="workContact">
						 ...
						 <tr class="name_Table">
							 ...
							 <td id="otherTxtWork" class="pmpro_checkout-field name_Table" style="visibility:hidden;">
								 ...
								 <input type="text" id="company_other" name="company_other" style="margin-top: 5%;" value="<?php if (!empty( $pmpro_error_fields)) {
									 echo $company_other;
								 }
								 else {
						 ...
						 <tr class="name_Table">
							 ...
							 <td id="company_state_div" class="pmpro_checkout-field name_Table">
								 ...
								 <select id="company_state" name="company_state" style="margin-top: -5%;" class="input <?php echo pmpro_getClassForField("company_state");?>">
									 <option value=""></option>
									 <?php
					 ...
					 <table class="name_Table" id="schoolContact" style="display:none;">
						 <tr class="name_Table">
							 ...
							 <td id="otherTxtSchool" class="pmpro_checkout-field name_Table" style="visibility:hidden;">
								 ...
								 <input type="text" id="school_other" name="school_other" style="margin-top: 3%;" value="<?php if (!empty( $pmpro_error_fields)) {
									 echo $school_other;
								 }
								 else {
										 ...
										 <?php
											 ...
											 if (count($lang_name_arr) > 0){
												 for ($i = 0; $i < count($lang_name_arr); $i++){
													 ?>
													 <tr class="name_Table">
														 <td style="float: left; margin-top: 6%;" class="name_Table"><input type="text" name="lang_name[]" value="<?php echo esc_attr($lang_name_arr[$i]); ?>"
												 ...
												 <tbody class="name_Table">
													 <tr class="name_Table">
														 ...
														 <td id="otherTxtSchoolInfo_<?php echo $i ?>" class="pmpro_checkout-field name_Table otherTxtSchoolInfo" style="visibility:hidden;">
															 <label for="more_school_other">Other Law School</label>
															 <input type="text" id="more_school_other" name="more_school_other[]" style="margin-top: 3%;" value="<?php echo esc_attr($more_school_other_arr[$i]); ?>" size="20">
														 </td>
													 </tr>
													 <tr>
									 ...
									 <?php
										 ...
										 foreach($areas_arr as $area) {
											 ...
											 if ($area == "Other") {
												 ...
												 echo '<input type="text" id="area_other" name="area_other" value="'.$area_other.'" size="20" style="visibility:hidden; width: 30%;" placeholder="Other Area">';
											 }
											 else{
					 ...
					 <p>
						 <button type="submit" value="<?php esc_attr_e('Update Profile'); ?>" style="float:left;"><?php esc_html_e('Update Profile'); ?></button>
						 <a href="<?php echo "http://" . $_SERVER['SERVER_NAME'] . "/membership-account"?>" style="margin-top:0;" class="kaba_BtnLink"><?php _e("BACK", 'paid-memberships-pro' );?></a>
					 </p>
				 </form>
					 </div><!-- #content -->
				 </div><!-- #primary -->
