...
function srz_fb_albums() {
	...
	if ( isset( $_REQUEST['srzf'] ) ) {
		...
		echo '<h2 class="mb3">Albums<a href="admin.php?page=SrzFb-Albums&srzf=edit" class="add-new-h2">' . __( 'Add New', 'srizon-facebook-album' ) . '</a></h2>';
...
function srz_fb_albums_edit() {
	...
	SrizonFBUI::renderBoxHeader( 'box1', __( "About Single Album", 'srizon-facebook-album' ) );
