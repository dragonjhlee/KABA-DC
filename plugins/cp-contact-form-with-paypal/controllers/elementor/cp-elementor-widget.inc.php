    ...
    class CP_ContactFormwPayPal_Elementor {
      ...
      function enqueue_frontend_styles() {
          ...
          wp_enqueue_script( $this->prefix.'_builder_script',
                 plugins_url('/../../js/fbuilder.jquery.js', __FILE__),array("jquery","jquery-ui-core","jquery-ui-datepicker","jquery-ui-widget","jquery-ui-position","jquery-ui-tooltip","query-stringify",$this->prefix."_validate_script"), false, true );          
      }      
