...
$( window ).load(function() {
        document.querySelector('[data-slug="<?php echo $cpcfwpp_plugslug; ?>"] .deactivate a').addEventListener('click', function(event){
            event.preventDefault()
            var urlRedirect = document.querySelector('[data-slug="<?php echo $cpcfwpp_plugslug; ?>"] .deactivate a').getAttribute('href');
      		   ...
      		   '</div></div>'
                  ...
                  buttons: [
                      ...
                      },
                      {
                        ...
                        click: function() {
                                   window.open('<?php echo $cpcfwpp_supportlink_full; ?>');
      						       $(this).dialog("close");
      				           }                            
                      },
                      {
