...
<div class="wrap">
<h1>PayPal Form - <?php _e('Settings for','cp-contact-form-with-paypal'); ?>: <span style="color:#006600;font-weight:bold;"><?php echo cp_contactformpp_get_option('form_name', ''); ?></span></h1>
...
<select name="currency" style="vertical-align:baseline;" onchange="javascript:cpExplainCurrency(this);">
...
<p>If you need further information or solution about this currency setting you can <a href="https://cfpaypal.dwbooster.com/contact-us">contact our support service</a>.</p>
       ...
       <tr valign="top">
        ...
        <td>
          ...
          <div id="cpcfppmorein1" style="display:none;border:1px solid black;background-color:#ffffcc;padding:10px;">
           <p>Note: The <a href="https://cfpaypal.dwbooster.com/download">commercial versions</a> work also without PayPal to convert the form in a general purpose form with or without payment involved. The <a href="https://cfpaypal.dwbooster.com/download">Platinum version</a> supports integration with other payments gateways like Stripe, PayPal Pro, iDeal and RedSys.</p>
        ...
        <tr valign="top">        
        <th scope="row"><?php _e('When should be sent the notification-confirmation emails?','cp-contact-form-with-paypal'); ?></th>
        <td>
 ...
 <div id="metabox_basic_settings" class="postbox" >
  ...
  <div class="inside">   
     ...
     <div id="cpwppdialog" title="Contact form">
