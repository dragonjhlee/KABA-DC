...
<?php if (cp_contactformpp_get_option('cv_enable_captcha', CP_CONTACTFORMPP_DEFAULT_cv_enable_captcha,$id) != 'false') { ?>
  <?php echo __('Please enter the security code','cp-contact-form-with-paypal'); ?>:<br />
  ...
  <br />
  <?php echo __('Security Code','cp-contact-form-with-paypal'); ?>:<br />
  <div class="dfield">
   ...
   <div class="cpefb_error message" id="hdcaptcha_error<?php echo $CP_CPP_global_form_count; ?>" generated="true" style="display:none;position: absolute; left: 0px; top: 25px;"><?php echo __('Incorrect captcha code. Please try again.','cp-contact-form-with-paypal'); ?></div>
  </div>
  <br />
<?php } ?>
</div>
<div id="cp_subbtn<?php echo $CP_CPP_global_form_count; ?>" class="cp_subbtn"><?php echo __($button_label,'cp-contact-form-with-paypal'); ?></div>
</form>