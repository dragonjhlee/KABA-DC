...
<form id="pmpro_form" class="pmpro_form" action="<?php if(!empty($_REQUEST['review'])) echo pmpro_url("checkout", "?level=" . $pmpro_level->id); ?>" method="post">
	...
	<label for="hide_directory">
		<input name="hide_directory" type="checkbox" id="hide_directory" <?php checked( get_user_meta($user->ID, 'pmpromd_hide_directory', true), 1 ); ?> value="1">
		<?php printf(__(' Click if you would <span style="text-decoration: underline;">not</span> like your information to be made publicly available.')); ?>
	</label>
		...
		<div class="pmpro_checkout-fields">
			...
			<?php if($pmpro_show_discount_code) { ?>
				...
				<?php } elseif(!$pmpro_review) { ?>
					<p id="other_discount_code_p" class="pmpro_small"><?php _e('If you have a discount code, click ', 'paid-memberships-pro' );?> <a id="other_discount_code_a" href="#discount_code"><?php _e('here', 'paid-memberships-pro' );?></a>.</p>
	...
	<div id="pmpro_user_fields" class="pmpro_checkout">
		...
		<div class="pmpro_checkout-fields">		
			...
			<div class="pmpro_checkout-field pmpro_checkout-field-bemail">
				<label for="bemail"><?php _e('Preferred Email Address', 'paid-memberships-pro' );?></label>
