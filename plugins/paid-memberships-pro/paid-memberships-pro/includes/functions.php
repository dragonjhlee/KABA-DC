...
function pmpro_getClassForField( $field ) {
	...
	global $pmpro_required_user_profile, $pmpro_required_user_profile_school, $pmpro_required_user_profile_work; // KABA
	$classes = array();
	...
	if ( is_array( $pmpro_required_billing_fields ) && is_array( $pmpro_required_user_fields ) && is_array( $pmpro_required_user_profile ) && is_array( $pmpro_required_user_profile_school ) && is_array( $pmpro_required_user_profile_work )) {
		$required_fields = array_merge( array_keys( $pmpro_required_billing_fields ), array_keys( $pmpro_required_user_fields ), array_keys( $pmpro_required_user_profile ), array_keys( $pmpro_required_user_profile_school ), array_keys( $pmpro_required_user_profile_work ));
	...
	} elseif ( is_array( $pmpro_required_user_profile ) ) {
		$required_fields = array_keys( $pmpro_required_user_profile );
	} elseif ( is_array( $pmpro_required_user_profile_school ) ) {
		$required_fields = array_keys( $pmpro_required_user_profile_school );
	} elseif ( is_array( $pmpro_required_user_profile_work ) ) {
		$required_fields = array_keys( $pmpro_required_user_profile_work );
	} else {
