...
function pmpro_getClassForField( $field ) {
	global $pmpro_error_fields, $pmpro_required_billing_fields, $pmpro_required_user_fields, $pmpro_required_user_profile;
	$classes = array();
	...
	if ( is_array( $pmpro_required_billing_fields ) && is_array( $pmpro_required_user_fields ) && is_array( $pmpro_required_user_profile )) {
		$required_fields = array_merge( array_keys( $pmpro_required_billing_fields ), array_keys( $pmpro_required_user_fields ), array_keys( $pmpro_required_user_profile ));
