...
<form id="pmpro_form" class="pmpro_form" action="<?php if(!empty($_REQUEST['review'])) echo pmpro_url("checkout", "?level=" . $pmpro_level->id); ?>" method="post" enctype="multipart/form-data">
...
<!--
	...
	// KABA
	jQuery('#pmpro_mailing_lists').hide();
-->
</script>
<script>
<!--
