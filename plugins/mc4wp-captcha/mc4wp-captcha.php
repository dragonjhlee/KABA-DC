...
Copyright (C) 2015-2018, Danny van Kooten, danny@ibericode.com
...
function _bootstrap_mc4wp_captcha() {
	...
	add_filter( 'gglcptch_exclude_forms', 'mc4wp_captcha_exclude_form_from_ajax_check' );
	add_action( 'wp_footer', 'mc4wp_captcha_print_js' );
